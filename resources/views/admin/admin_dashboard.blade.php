<x-app-layout>
    ...
    <div class="flex justify-between flex-wrap items-center mb-6">
        <h4
            class="font-medium lg:text-2xl text-xl capitalize text-slate-900 inline-block ltr:pr-4 rtl:pl-4 mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
            Dashboard</h4>
                                                        ...
                                                        <div class="flex-none">
                                                            <div class="w-8 h-8 rounded-[100%] ltr:mr-3 rtl:ml-3">
                                                                <img class="w-full h-full rounded-[100%] object-cover"
                                                                    src="{{ $user->getFirstMediaUrl('profile-image', 'preview') ?: Avatar::create($user->name)->toBase64() }}" />
                                                            </div>
                                                        </div>
